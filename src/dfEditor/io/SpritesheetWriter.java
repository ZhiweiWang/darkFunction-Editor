...
public class SpritesheetWriter
{
    ...
    public void createSpriteSheet(File aSaveFile, File aImageFile, JTree aTree, int aImageWidth, int aImageHeight) throws IOException
    {    
        try
        {
            ...
            xmlwriter.writeAttribute("name", aImageFile.getName());
            xmlwriter.writeAttribute("imgpath", PathUtils.relativePath(aImageFile.getPath(), aSaveFile.getParent()));
