...
public class SpriteGraphic extends GraphicObject {
    ...
    public SpriteGraphic(BufferedImage aImage, Point aPoint, Rectangle aSubRect, String preferName) {
        this(aImage, aPoint, aSubRect);
